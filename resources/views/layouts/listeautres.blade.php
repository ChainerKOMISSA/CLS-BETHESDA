        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Autres produits</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Autres produits</h3>
          <div class="card-tools">
            <a href="{{route('listeproduits')}}" class="btn btn-secondary">Liste des produits</a>
            <a href="{{route('newproduit')}}" class="btn btn-primary">Vendre un produit</a>
        ...
        <div class="card-body p-0">
          ...
          <table class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr>
                <th scope="row">{{++$key}}</th>
                <td>{{$autre->nomproduit}}</td>
                <td>{{$autre->prixproduit}}</td>
                <td>{{$autre->qtestock}}</td>
                <td>{{$autre->qtevendue}}</td>
              </tr>
              @endforeach
            </tbody>
          </table>
