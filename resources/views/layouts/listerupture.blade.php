        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Stock de produits</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Produits en rupture</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body p-0">
          ...
          <table class="table table-bordered table-hover">
            ...
            <tbody>
                @foreach ($ruptures as $key => $rupture)
              <tr>
                <th scope="row">{{++$key}}</th>
                <td>{{$rupture->nomproduit}}</td>
                <td>{{$rupture->prixproduit}}</td>
                <td style="color: red">{{$rupture->qtestock}}</td>
              </tr>
              @endforeach
            </tbody>
          </table>
