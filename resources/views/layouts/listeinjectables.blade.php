        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Liste des injectables</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Liste des injectables</h3>
          <div class="card-tools">
            <a href="{{route('newproduit')}}" class="btn btn-primary">Vendre un injectable</a>
        ...
        <div class="card-body p-0">
          ...
          <table class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr>
                <th scope="row">{{++$key}}</th>
                <td>{{$injectable->nomproduit}}</td>
                <td>{{$injectable->prixproduit}}</td>
                <td>{{$injectable->qtestock}}</td>
                <td>{{$injectable->qtevendue}}</td>
              </tr>
              @endforeach
            </tbody>
          </table>
